...
import gear_sonic.sonic_xr_pipeline.official_task  # noqa: F401
...
def create_environment_config(
    ...
    from gear_sonic.sonic_xr_pipeline.demo_cameras import install_demo_cameras
    install_demo_cameras(env_cfg)
